...
const UserDashboard = () => {
  ...
  const navigationItems = [
    ...
    { id: 'loan-status', label: 'Loan Status', icon: 'document' },
    { id: 'loan-application', label: 'Apply for Loan', icon: 'plus-circle' }
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div className="transition-all duration-300">
          ...
          {activeView === 'loan-status' && (
            <div className="animate-fadeIn">
              <LoanStatusPanel />
            </div>
          )}
          
          {activeView === 'loan-application' && (
            <div className="animate-fadeIn">
              <LoanApplication />
            </div>
          )}
