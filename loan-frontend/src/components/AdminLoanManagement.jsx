...
const AdminLoanManagement = () => {
  ...
  const fetchMetrics = async () => {
    try {
      ...
      const response = await fetch('https://crediflow-vhy5.onrender.com/api/admin/loans/metrics', {
        headers: {
  ...
  const exportCsv = async () => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch('https://crediflow-vhy5.onrender.com/api/admin/loans/export/csv', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const exportPdf = async () => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch('https://crediflow-vhy5.onrender.com/api/admin/loans/export/pdf', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const fetchAllLoans = async () => {
    try {
      ...
      const response = await fetch(`https://crediflow-vhy5.onrender.com/api/admin/loans?${params}`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const handleViewAuditLogs = async (loanId) => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`https://crediflow-vhy5.onrender.com/api/admin/loans/${loanId}/audit-logs`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const confirmUnderReview = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`https://crediflow-vhy5.onrender.com/api/admin/loans/${selectedLoan.id}/under-review`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const handleView = async (loanId) => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`https://crediflow-vhy5.onrender.com/api/admin/loans/${loanId}`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const confirmApprove = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`https://crediflow-vhy5.onrender.com/api/admin/loans/${selectedLoan.id}/approve`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const confirmReject = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`https://crediflow-vhy5.onrender.com/api/admin/loans/${selectedLoan.id}/reject`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
